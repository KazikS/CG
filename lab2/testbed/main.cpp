...
// Camera view via Transform matrix (variant 3 requirement)
...
void initialize(VkCommandBuffer cmd) {
    ...
    // Build pipeline
    {
        ...
        VkDescriptorPoolCreateInfo pool_info{
            ...
            .maxSets = 4,
            .poolSizeCount = 3, .pPoolSizes = pools,
        };
    ...
    models.push_back({
        .mesh = sphere_mesh,
        .transform = Transform{.position = {2.5f, -0.5f, 0.0f}},
        .albedo_color = {0.15f, 0.8f, 0.3f},
        .specular_color = {1.0f, 1.0f, 1.0f},
        .shininess = 64.0f,
    });

    // Second cube (white, back)
    models.push_back({
        .mesh = cube_mesh,
        .transform = Transform{.position = {0.0f, -0.5f, -3.0f}, .scale = {1.5f, 1.5f, 1.5f}},
        .albedo_color = {0.9f, 0.9f, 0.9f},
        .specular_color = {1.0f, 1.0f, 1.0f},
        .shininess = 8.0f,
    });
...
void update(double time) {
    ...
    // Camera control via mouse + keyboard
